...
public class PetPanda extends EntityPanda implements PetPlaySound
{

    public PetPanda(Location loc, Player p)
    {
        super(EntityTypes.PANDA, ((CraftWorld) Objects.requireNonNull(loc.getWorld())).getHandle());
