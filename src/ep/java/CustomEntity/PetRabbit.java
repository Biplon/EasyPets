...
public class PetRabbit extends EntityRabbit implements PetPlaySound
{

    public PetRabbit(Location loc, Player p)
    {
        super(EntityTypes.RABBIT, ((CraftWorld) Objects.requireNonNull(loc.getWorld())).getHandle());
