...
public class PetCow extends EntityCow implements PetPlaySound
{

    public PetCow(Location loc, Player p)
    {
        super(EntityTypes.COW, ((CraftWorld) Objects.requireNonNull(loc.getWorld())).getHandle());
