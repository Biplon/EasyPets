...
public class PetDonkey extends EntityHorseDonkey implements PetPlaySound
{
    public PetDonkey(Location loc, Player p)
    {
        super(EntityTypes.DONKEY, ((CraftWorld) Objects.requireNonNull(loc.getWorld())).getHandle());
