...
public class PetDZombie extends EntityDrowned implements PetPlaySound
{

    public PetDZombie(Location loc, Player p)
    {
        super(EntityTypes.DROWNED, ((CraftWorld) Objects.requireNonNull(loc.getWorld())).getHandle());
