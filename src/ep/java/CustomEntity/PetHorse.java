...
public class PetHorse extends EntityHorse implements PetPlaySound
{
    public PetHorse(Location loc, Player p, int variant)
    {
        super(EntityTypes.HORSE, ((CraftWorld) Objects.requireNonNull(loc.getWorld())).getHandle());
