...
public class PetZHorse extends EntityHorseZombie implements PetPlaySound
{
    public PetZHorse(Location loc, Player p)
    {
        super(EntityTypes.ZOMBIE_HORSE, ((CraftWorld) Objects.requireNonNull(loc.getWorld())).getHandle());
