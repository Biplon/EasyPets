...
public class PetEndermite extends EntityEndermite implements PetPlaySound
{

    public PetEndermite(Location loc, Player p)
    {
        super(EntityTypes.ENDERMITE, ((CraftWorld) Objects.requireNonNull(loc.getWorld())).getHandle());
